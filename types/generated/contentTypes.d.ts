...
export interface ApiBoutielleBoutielle extends Struct.CollectionTypeSchema {
  collectionName: 'boutielles';
  info: {
    displayName: 'Boutielles';
    pluralName: 'boutielles';
    singularName: 'boutielle';
  };
  options: {
...
export interface ApiEvenementEvenement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Reservation: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::boutielle.boutielle': ApiBoutielleBoutielle;
